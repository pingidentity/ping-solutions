...
cat ./.gitlab-ci/cypress.d/cypress/base_files/runner_tests/delete_env.base | \
...
.gitlab-ci/cypress.d/cypress/integration/WF/01-delete_WF_env.js 
...
.gitlab-ci/cypress.d/cypress/integration/CIAM/02-delete_CIAM_env.js 
