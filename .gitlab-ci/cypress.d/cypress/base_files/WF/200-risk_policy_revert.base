...
describe('Check ENV_NM is reverted to base state from High Risk Policy configuration', () => {
    it('Visits PingOne Console', () => {
      ...
      //find expected vaule
      cy.getIframeBody().find('[data-id="expandable-row"]').contains('Default Risk Policy');
      //sign off
